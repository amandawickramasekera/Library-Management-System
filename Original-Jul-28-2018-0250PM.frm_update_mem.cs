...
namespace Library
{
    public partial class frm_update_mem : Form
    {
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand(" select m_name ='"+txt_m_name.Text.ToString()+"', m_address = '"+txt_address.Text.ToString()+"', gs_div = '"+cmb_div.SelectedItem.ToString()+"'from Member where nic = '" +txt_search.Text+ "' ", con);
            con.Close();
        }
